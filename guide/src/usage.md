...
Health Connect; local sleeps are synchronized back after the wipe. On Android 9 through 13, only
the most recent 30 days are imported and reconciled, so a reliable wipe is not available. On
Android 14 or newer, Health Connect can provide an additional recovery source if its Scheduled
export is configured to cloud storage and exports are completing successfully. Health Connect should 
